<div>
    ...
    @if (session()->has('success'))
        <div class="px-4 py-3 mb-4 text-green-700 bg-green-100 border border-green-400 rounded-lg" role="alert">
        ...
        <form method="POST" wire:submit.prevent="submit">
            ...
            <label class="block mb-6">
                ...
                <input
                    ...
                    autofocus
                    class="block w-full mt-1 border-gray-300 rounded-lg hover:border-fuchsia-600 focus:ring-fuchsia-800 focus:border-fuchsia-800"
                />
            ...
            <label class="block mb-6">
                ...
                <textarea
                    ...
                    name="message"
                    rows="3"
                    placeholder="I would love to get in contact with you about a project I am wanting to get quoted. I have $$$ to spend and I am looking for a great company to work with."
                    class="block w-full mt-1 border-gray-300 rounded-lg hover:border-fuchsia-600 focus:ring-fuchsia-800 focus:border-fuchsia-800"
                ></textarea>
